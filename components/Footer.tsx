...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-[var(--card-border)] bg-[var(--card)]/50 backdrop-blur-sm mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-[var(--muted-foreground)] leading-relaxed">
              Building innovative AI-powered applications and modern web experiences.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              {personalData.contact.twitter && (
                <a
                  href={personalData.contact.twitter}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[var(--muted-foreground)] hover:text-[var(--accent)] transition-colors"
                  aria-label="Twitter"
